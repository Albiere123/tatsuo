...
exports.run = async (client, message, args) => {
    ...
    try {
        const user = await db.get(userId) || { money: 0, sb: null};
        user.money += reward;
        ...
        const embed = new Discord.EmbedBuilder()
            .setColor(client.cor)
            .setDescription(`# <:cardapio:966742180335075358> | Daily
ㅤ
**( <:graficodebarras:966747162211934268> ) Quanto ganhou:** R$${api.ab(reward)}
ㅤ
**( <:casa:966742242834407447> ) Saldo atual:** R$${api.ab(user.money)}`)
