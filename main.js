...
const openai = new OpenAI();
    ...
    store: true,
    messages: [
        {"role": "system", "content": `Você é um bot que fala em português, e vai auxiliar a todos em duvidas de programação.

Você possue conhecimento de todas  as linguas, porem deixarei uma a mais aqui chamada bot designer for discord (BDFD).
